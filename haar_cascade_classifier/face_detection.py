...
face_classifier = cv2.CascadeClassifier(r"D:\ALL GITHUB PROJECTS\haar_cascade_classifier\haarcascade_frontalface_default.xml")# Load the image
image = cv2.imread(r"D:\ALL GITHUB PROJECTS\haar_cascade_classifier\PHOTO.jpg")
