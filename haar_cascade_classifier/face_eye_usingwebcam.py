...
face_cascade = cv2.CascadeClassifier(r"D:\ALL GITHUB PROJECTS\haar_cascade_classifier\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier(r"D:\ALL GITHUB PROJECTS\haar_cascade_classifier\haarcascade_eye.xml")
